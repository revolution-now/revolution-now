...
** Helpers
*****************************************************************/
UnitId create_unit( World& W, e_player player, UnitType ut ) {
  return create_free_unit( W.units(), W.player( player ), ut );
}
...
TEST_CASE( "CargoHold add/remove to/from size-0 cargo hold" ) {
  ...
  auto unit_id = create_unit( W, e_player::english,
...
TEST_CASE( "CargoHold add/remove from size-1 cargo hold" ) {
  ...
  UnitId id = create_unit( W, e_player::english,
                           e_unit_type::free_colonist );
...
TEST_CASE(
  ...
  auto unit_id =
      create_unit( W, e_player::english, e_unit_type::treasure );
...
TEST_CASE( "CargoHold try to add too many things" ) {
  ...
  auto unit_id1 = create_unit( W, e_player::english,
                               e_unit_type::free_colonist );
  auto unit_id2 =
      create_unit( W, e_player::english, e_unit_type::treasure );
  auto unit_id3 =
...
TEST_CASE( "CargoHold add multiple units" ) {
  ...
  auto unit_id2 =
      create_unit( W, e_player::english, e_unit_type::treasure );
  auto unit_id3 =
      create_unit( W, e_player::english, e_unit_type::soldier );
...
TEST_CASE( "CargoHold try add as available from all (units)" ) {
  ...
  UnitId unit_ids[6];
  for( auto i = 0; i < 6; ++i )
    unit_ids[i] = create_unit( W, e_player::english,
                               e_unit_type::free_colonist );
...
TEST_CASE( "CargoHold compactify multiple units" ) {
  ...
  auto unit_id1 = create_unit( W, e_player::english,
                               e_unit_type::free_colonist );
  auto unit_id2 = create_unit( W, e_player::english,
                               e_unit_type::free_colonist );
  auto unit_id3 =
      create_unit( W, e_player::english, e_unit_type::treasure );
  auto unit_id4 =
  ...
  REQUIRE( ch[13] == CargoSlot::cargo{
                       /*contents=*/Cargo::unit{ unit_id4 } } );
  REQUIRE( ch[19] == CargoSlot::cargo{
  ...
  REQUIRE( ch[6] == CargoSlot::cargo{
                      /*contents=*/Cargo::unit{ unit_id4 } } );
  REQUIRE( ch[12] == CargoSlot::cargo{
                       /*contents=*/Cargo::unit{ unit_id5 } } );
  REQUIRE( ch[18] == CargoSlot::cargo{
                       /*contents=*/Cargo::unit{ unit_id1 } } );
  REQUIRE( ch[19] == CargoSlot::cargo{
                       /*contents=*/Cargo::unit{ unit_id2 } } );
...
TEST_CASE(
  ...
  REQUIRE( ch[2] ==
           CargoSlot::cargo{
             /*contents=*/Cargo::commodity{ food_overflow } } );
  REQUIRE( ch[3] ==
           CargoSlot::cargo{
             /*contents=*/Cargo::commodity{ sugar_full } } );
  REQUIRE( ch[4] ==
           CargoSlot::cargo{
             /*contents=*/Cargo::commodity{ sugar_combined } } );
  REQUIRE( ch[5] == CargoSlot::empty{} );
  REQUIRE( ch[6] == CargoSlot::empty{} );
