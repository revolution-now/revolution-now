...
TEST_CASE( "[render/typer] write_char" ) {
  ...
  expected = {
      ...
      // new line.
      // (20, 34): Y
      Vert( { .x = 20+2*0, .y = 34 + 1 }, { .x = 9*2,   .y = 5*4   } ),
      Vert( { .x = 20+2*0, .y = 38 + 1 }, { .x = 9*2,   .y = 5*4+4 } ),
      Vert( { .x = 22+2*0, .y = 38 + 1 }, { .x = 9*2+2, .y = 5*4+4 } ),
      Vert( { .x = 20+2*0, .y = 34 + 1 }, { .x = 9*2,   .y = 5*4   } ),
      Vert( { .x = 22+2*0, .y = 34 + 1 }, { .x = 9*2+2, .y = 5*4   } ),
      Vert( { .x = 22+2*0, .y = 38 + 1 }, { .x = 9*2+2, .y = 5*4+4 } ),
      // (20, 34): e
      Vert( { .x = 20+2*1, .y = 34 + 1 }, { .x = 5*2,   .y = 6*4   } ),
      Vert( { .x = 20+2*1, .y = 38 + 1 }, { .x = 5*2,   .y = 6*4+4 } ),
      Vert( { .x = 22+2*1, .y = 38 + 1 }, { .x = 5*2+2, .y = 6*4+4 } ),
      Vert( { .x = 20+2*1, .y = 34 + 1 }, { .x = 5*2,   .y = 6*4   } ),
      Vert( { .x = 22+2*1, .y = 34 + 1 }, { .x = 5*2+2, .y = 6*4   } ),
      Vert( { .x = 22+2*1, .y = 38 + 1 }, { .x = 5*2+2, .y = 6*4+4 } ),
      // (20, 34): s
      Vert( { .x = 20+2*2, .y = 34 + 1 }, { .x = 3*2,   .y = 7*4   } ),
      Vert( { .x = 20+2*2, .y = 38 + 1 }, { .x = 3*2,   .y = 7*4+4 } ),
      Vert( { .x = 22+2*2, .y = 38 + 1 }, { .x = 3*2+2, .y = 7*4+4 } ),
      Vert( { .x = 20+2*2, .y = 34 + 1 }, { .x = 3*2,   .y = 7*4   } ),
      Vert( { .x = 22+2*2, .y = 34 + 1 }, { .x = 3*2+2, .y = 7*4   } ),
      Vert( { .x = 22+2*2, .y = 38 + 1 }, { .x = 3*2+2, .y = 7*4+4 } ),
  };
  // clang-format on
  REQUIRE( v == expected );
