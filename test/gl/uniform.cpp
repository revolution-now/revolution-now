...
TEST_CASE( "[uniform] creation/set float" ) {
  ...
  {
    gl::MockOpenGL mock2;
    EXPECT_CALL( mock2, gl_UseProgram( 7 ) );
    EXPECT_CALL( mock2, gl_GetError() ).returns( GL_NO_ERROR );
    EXPECT_CALL( mock2, gl_Uniform1f( 88, 5.5 ) );
    EXPECT_CALL( mock2, gl_GetError() )
  ...
  EXPECT_CALL( mock, gl_Uniform1f( 88, 5.5 ) );
...
TEST_CASE( "[uniform] creation/set long" ) {
  ...
  // Set long failure.
  {
    ...
    EXPECT_CALL( mock2, gl_UseProgram( 7 ) );
    EXPECT_CALL( mock2, gl_GetError() ).returns( GL_NO_ERROR );
    EXPECT_CALL( mock2, gl_Uniform1i( 88, 5 ) );
    EXPECT_CALL( mock2, gl_GetError() )
        .returns( GL_INVALID_OPERATION );
    EXPECT_CALL( mock2, gl_GetError() ).returns( GL_NO_ERROR );
    REQUIRE(
  ...
  EXPECT_CALL( mock, gl_GetError() )
      ...
      .returns( GL_NO_ERROR );
  EXPECT_CALL( mock, gl_UseProgram( 7 ) );
  EXPECT_CALL( mock, gl_Uniform1i( 88, 5 ) );
  ...
  EXPECT_CALL( mock, gl_GetError() )
      ...
      .returns( GL_NO_ERROR );
  EXPECT_CALL( mock, gl_UseProgram( 7 ) );
  EXPECT_CALL( mock, gl_Uniform1i( 88, 6 ) );
...
TEST_CASE( "[uniform] creation/set bool" ) {
  ...
  // Set bool failure.
  {
    ...
    EXPECT_CALL( mock2, gl_UseProgram( 7 ) );
    EXPECT_CALL( mock2, gl_GetError() ).returns( GL_NO_ERROR );
    EXPECT_CALL( mock2, gl_Uniform1i( 88, true ) );
    EXPECT_CALL( mock2, gl_GetError() )
        .returns( GL_INVALID_OPERATION );
    EXPECT_CALL( mock2, gl_GetError() ).returns( GL_NO_ERROR );
    REQUIRE(
  ...
  EXPECT_CALL( mock, gl_GetError() )
      ...
      .returns( GL_NO_ERROR );
  EXPECT_CALL( mock, gl_UseProgram( 7 ) );
  EXPECT_CALL( mock, gl_Uniform1i( 88, true ) );
  ...
  EXPECT_CALL( mock, gl_GetError() )
      ...
      .returns( GL_NO_ERROR );
  EXPECT_CALL( mock, gl_UseProgram( 7 ) );
  EXPECT_CALL( mock, gl_Uniform1i( 88, false ) );
...
TEST_CASE( "[uniform] creation/set vec2" ) {
  ...
  // Set vec2 failure.
  {
    ...
    EXPECT_CALL( mock2, gl_UseProgram( 7 ) );
    EXPECT_CALL( mock2, gl_GetError() ).returns( GL_NO_ERROR );
    EXPECT_CALL( mock2, gl_Uniform2f( 88, 4.5, 5.6 ) );
    EXPECT_CALL( mock2, gl_GetError() )
        .returns( GL_INVALID_OPERATION );
    EXPECT_CALL( mock2, gl_GetError() ).returns( GL_NO_ERROR );
    REQUIRE(
  ...
  EXPECT_CALL( mock, gl_GetError() )
      ...
      .returns( GL_NO_ERROR );
  EXPECT_CALL( mock, gl_UseProgram( 7 ) );
  EXPECT_CALL( mock, gl_Uniform2f( 88, 4.5, 5.6 ) );
  ...
  EXPECT_CALL( mock, gl_GetError() )
      ...
      .returns( GL_NO_ERROR );
  EXPECT_CALL( mock, gl_UseProgram( 7 ) );
  EXPECT_CALL( mock, gl_Uniform2f( 88, 6.7, 7.8 ) );
