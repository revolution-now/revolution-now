...
CFG( art,
  ...
  OBJ( tiles,
    ...
    OBJ( units,
      ...
      FLD( Delta, size )
      OBJ( coords,
        FLD( Coord, petty_criminal )
        FLD( Coord, indentured_servant )
        FLD( Coord, free_colonist )
        FLD( Coord, soldier )
        FLD( Coord, dragoon )
        FLD( Coord, pioneer )
        FLD( Coord, missionary )
        FLD( Coord, scout )
        FLD( Coord, expert_farmer )
        FLD( Coord, expert_fisherman )
        FLD( Coord, expert_sugar_planter )
        FLD( Coord, expert_tobacco_planter )
        FLD( Coord, expert_cotton_planter )
        FLD( Coord, expert_fur_trapper )
        FLD( Coord, expert_lumberjack )
        FLD( Coord, expert_ore_miner )
        FLD( Coord, expert_silver_miner )
        FLD( Coord, master_carpenter )
        FLD( Coord, master_rum_distiller )
        FLD( Coord, master_tobacconist )
        FLD( Coord, master_weaver )
        FLD( Coord, master_fur_trader )
        FLD( Coord, master_blacksmith )
        FLD( Coord, master_gunsmith )
        FLD( Coord, elder_statesman )
        FLD( Coord, firebrand_preacher )
        FLD( Coord, hardy_colonist )
        FLD( Coord, jesuit_colonist )
        FLD( Coord, seasoned_colonist )
        FLD( Coord, veteran_colonist )
        FLD( Coord, veteran_soldier )
        FLD( Coord, veteran_dragoon )
        FLD( Coord, continental_army )
        FLD( Coord, continental_cavalry )
        FLD( Coord, regular )
        FLD( Coord, cavalry )
        FLD( Coord, hardy_pioneer )
        FLD( Coord, jesuit_missionary )
        FLD( Coord, seasoned_scout )
        FLD( Coord, artillery )
        FLD( Coord, damaged_artillery )
        FLD( Coord, caravel )
