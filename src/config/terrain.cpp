...
maybe<e_biome> to_ground_terrain( e_terrain terrain ) {
  switch( terrain ) {
    case e_terrain::arctic:
      return e_biome::arctic;
    ...
    case e_terrain::desert:
      return e_biome::desert;
    case e_terrain::grassland:
      return e_biome::grassland;
    case e_terrain::hills:
      return nothing;
    case e_terrain::marsh:
      return e_biome::marsh;
    ...
    case e_terrain::plains:
      return e_biome::plains;
    case e_terrain::prairie:
      return e_biome::prairie;
    case e_terrain::rain:
      return nothing;
    case e_terrain::savannah:
      return e_biome::savannah;
    case e_terrain::scrub:
      return nothing;
    case e_terrain::swamp:
      return e_biome::swamp;
    case e_terrain::tropical:
      return nothing;
    case e_terrain::tundra:
      return e_biome::tundra;
    case e_terrain::wetland:
      return nothing;
  }
}

e_terrain from_ground_terrain( e_biome ground ) {
  switch( ground ) {
    case e_biome::arctic:
