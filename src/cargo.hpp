...
public:
  ...
  bool can_add( Cargo cargo ) const;
  bool has_cargo( Cargo cargo ) const;

private:
  friend void add_unit_to_cargo( CargoHold& cargo, UnitId );
  friend void remove_unit_from_cargo( CargoHold& cargo, UnitId );
