...
constexpr W g_viewport_width_tiles{28}; //{48};
constexpr H g_viewport_height_tiles{15}; //{26};

// At standard zoom, when tile size is (g_tile_width, g_tile_height);
constexpr W g_world_viewport_width_tiles{22}; //{40};
constexpr H g_world_viewport_height_tiles{14}; //{25};
