...
layout (location = 5)  in vec2  in_atlas_center;
layout (location = 6)  in vec2  in_atlas_target_offset;
layout (location = 7)  in vec4  in_fixed_color;
layout (location = 8)  in float in_alpha_multiplier;
layout (location = 9)  in float in_scaling;
layout (location = 10) in vec2  in_translation;
layout (location = 11) in int   in_color_cycle;
layout (location = 12) in int   in_use_camera;
